...
require([
    ...
    var api = apiData.api;
        ...
        //
        var newList = [];
        var umlauts = { 'Ã¤': 'ae', 'Ã¼': 'ue', 'Ã¶': 'oe', 'ÃŸ': 'ss' }; // TODO: remove in version 1.0
        $.each (apiByGroupAndName, function(index, groupEntries) {
            ...
            $.each (groupEntries, function(titleName, entries) {
                ...
                if(title !== undefined) {
                    title.toLowerCase().replace(/[Ã¤Ã¶Ã¼ÃŸ]/g, function($0) { return umlauts[$0]; });
